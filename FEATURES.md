...
- Actions panel on a result: Open With, app location, launch in terminal
...
- ECB/Frankfurter-based rates, **12 hour** cache
...
- Full docs: [docs/TRANSLATE.md](docs/TRANSLATE.md)
...
- Related docs: [docs/performance.md](docs/performance.md), [docs/OPTIMIZATION.md](docs/OPTIMIZATION.md)
