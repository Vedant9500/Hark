...
| P3 | ureq honors proxy env vars unscoped — **fixed 2026-08-28**: all three agents built with `try_proxy_from_env(false)`; test `agents_ignore_proxy_env` | `http.rs:16-21` | 16 |
